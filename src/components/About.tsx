    ...
    <section id="about" aria-labelledby="about-heading" className="section-shell section-secondary">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="section-heading">
          ...
          <h2 id="about-heading">Profile</h2>
          <p>
            A compact snapshot of background, technical direction, and project strengths.
          </p>
        </div>
        ...
        <div className="grid gap-5 lg:grid-cols-[0.72fr_1.28fr] lg:items-stretch">
          ...
          <div className="premium-card p-4 sm:p-6">
            ...
            <div className="text-soft mt-4 space-y-4 text-sm leading-6 sm:text-base sm:leading-7">
              <p>
                Computer Science &amp; Engineering student at PES University, Bengaluru, with
              ...
              <p>
                Recent work includes the CoreStack industry capstone, ModelMatrix, building
                AI model benchmarking and recommendation workflows with AWS Bedrock, Google Vertex AI, and
                FastAPI services.
              </p>
              <p>
