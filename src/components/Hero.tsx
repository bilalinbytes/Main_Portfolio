...
const Hero = () => {
  return (
    <section id="home" className="section-primary relative overflow-hidden px-3 pb-9 pt-20 min-[380px]:px-4 sm:px-6 sm:pb-12 sm:pt-24 lg:px-8 lg:pt-28">
        ...
        <div className="grid items-center gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:gap-10">
          <div className="min-w-0 animate-fade-in-up">
            <div className="mb-5 inline-flex max-w-full items-center gap-2 rounded-full border border-teal-500/30 bg-teal-500/10 px-3 py-2 text-xs font-medium text-teal-800 dark:text-teal-200 sm:px-4 sm:text-sm">
              ...
              <span className="min-w-0 truncate">Software engineering + applied AI/ML</span>
            </div>
            ...
            <div className="mt-6 flex flex-col gap-3 sm:flex-row">
              <a href={cvFile} download className="inline-flex min-h-11 w-full items-center justify-center gap-2 rounded-lg bg-teal-700 px-5 py-3 text-sm font-semibold text-white shadow-lg shadow-teal-700/20 transition hover:bg-teal-600 sm:w-auto">
                <Download size={18} />
                Download Resume
              </a>
              <a href="mailto:mohammedbilal96654@gmail.com" className="inline-flex min-h-11 w-full items-center justify-center gap-2 rounded-lg border border-slate-200 bg-white px-5 py-3 text-sm font-semibold text-slate-950 transition hover:border-teal-500/50 hover:bg-teal-50 dark:border-white/10 dark:bg-white/[0.03] dark:text-white dark:hover:bg-teal-500/10 sm:w-auto">
                <Mail size={18} />
                Contact Me
              </a>
            </div>
          ...
          <div className="min-w-0 animate-slide-in-right space-y-4">
            <div className="premium-card overflow-hidden p-4 text-center sm:p-5">
              ...
              />
              <div className="mt-5">
                <p className="text-main text-lg font-semibold sm:text-xl">Software Engineering Candidate</p>
            ...
            <div className="premium-card overflow-hidden">
              ...
              <div className="terminal-panel space-y-3 p-3 font-mono text-xs sm:p-4 sm:text-sm">
